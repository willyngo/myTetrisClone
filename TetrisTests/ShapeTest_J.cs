...
namespace TetrisTests
{
    ...
    public class ShapeTest_J
    {
        ...
        [TestMethod]
        public void ShapeJ_Rotate3_EnoughSpace()
        {
            //a(5, 1)b(4, 1)c(6, 1)d(4, 0)

            Board board = new Board();
            ShapeJ shapeTest = new ShapeJ(board);
            ShapeJ shapeTest_expected = new ShapeJ(board);
            String expected = "(5, 1)(5, 0)(5, 2)(6, 0)";
        ...
        [TestMethod]
        public void ShapeJ_Rotate4_EnoughSpace()
        {
            //a(5, 1)b(5, 0)c(5, 2)d(6, 0)

            Board board = new Board();
            ShapeJ shapeTest = new ShapeJ(board);
            ShapeJ shapeTest_expected = new ShapeJ(board);
            String expected = "(5, 1)(6, 1)(4, 1)(6, 2)";
